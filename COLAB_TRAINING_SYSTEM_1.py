"""
SYSTEM 1 - Train on Assigned Dataset Splits
...
OUTPUT_MODEL_NAME = "fake-news-mega-split-1"
SPLIT_NUMBER = 1  # System id
TOTAL_SPLITS = 3
...
print("\n📋 Next Steps:")
print(f"   1. Run System 2 on another computer")
